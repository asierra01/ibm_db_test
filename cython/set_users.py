...
""" % (
    ...
    my_dict['DB2_PORT']))
        ...
        row1 = ['ibm_db.__file__', ibm_db.__file__]
        row2 = ['ibm_db.__doc__', ibm_db.__doc__]
        row3 = ['ibm_db.__version__', ibm_db.__version__]
        row4 = ['python sys.version', sys.version]
